...
public class Lec06KeepAliveTest extends AbstractChannelTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(Lec06KeepAliveTest.class);
